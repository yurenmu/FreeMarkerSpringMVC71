package com.zhangguo.springmvc.action;
...
import com.zhangguo.springmvc.entitie.Animals;
import com.zhangguo.springmvc.entitie.Article;
import com.zhangguo.springmvc.service.ArticleService;
...
public class NewsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
        ...
        if(!file.exists()){
            ...
            articleData.put("user", "user111");
            List animals=new ArrayList<>();
            
            
            Animals mouse = new Animals(1,1.0,"mouse");
            Animals hourse = new Animals(2,22.54,"hourse");
            Animals elephant = new Animals(3,33.33,"elephant");
            Animals python = new Animals(4,100.564,"python");

			animals.add(mouse);
            animals.add(hourse);
            animals.add(elephant);
            animals.add(python);
            articleData.put("animals", animals);
